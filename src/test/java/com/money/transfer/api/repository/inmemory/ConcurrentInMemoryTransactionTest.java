...
import com.money.transfer.api.model.User;
...
public class ConcurrentInMemoryTransactionTest {
    ...
    @Before
    public void setUp() {
        accountRepository = new InMemoryAccountRepository(new AccountValidationImpl());
        TransactionValidation transactionValidation = new TransactionValidationImpl(
                accountRepository
        );
    ...
    public void shouldHandleConcurrentTransactions() throws Exception {
        // given
        final Account sender = createSenderAccount("AC1", Money.of(CurrencyUnit.USD, 100));
        final Account receiver = createReceiverAccount("AC2", Money.of(CurrencyUnit.USD, 50));
        ...
        final Transaction transaction1 = Transaction
                ...
                .from(sender)
                .to(receiver)
                .money(Money.of(CurrencyUnit.USD, 5))
                .build();
        ...
        final Transaction transaction3 = Transaction
                ...
                .from(receiver)
                .to(sender)
                .money(Money.of(CurrencyUnit.USD, 1))
                .build();
        ...
        assertThat(senderMoney).isEqualTo(Money.of(CurrencyUnit.USD, 86));
        assertThat(receiverMoney).isEqualTo(Money.of(CurrencyUnit.USD, 64));
    }
